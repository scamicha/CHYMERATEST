...
pathf95
endef
TARCH  = -r8 -m64 -march=opteron -mcmodel=medium -convert little_endian
...
ifort
endef
TARCH  = -r8 -xT -mcmodel=medium -ipo -convert little_endian -shared-intel
CARCH  = -xT -mcmodel=medium
F95OPT = -O3 -pad -align all -nocheck -no-prec-div -shared-intel 
FIXED  = -fixed
FREE   = -free
INLINE = -ip
ifeq ($(ENDIAN),yes)
...
OBJ = 3dhyd-main.o fft.o flux.o housekeeping.o io.o misc.o pot3.o \
	...
	initengtable.o wiggle.o planet.o first_touch.o dwalltime.o
...
CLINK     = -L$(GSL_LIBPATH) -I$(GSL_INCPATH) -lgsl -lgslcblas
...
dwalltime.o: dwalltime.c
	$(CC) $(COPT) $(CLINK) -c dwalltime.c
